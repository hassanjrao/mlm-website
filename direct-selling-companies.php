...
<body>
    ...
    <head>
        ...
        <meta name="description" content="Direct selling companies">
        <meta name="keywords" content="Direct selling companies">

        <title>Direct Selling Companies</title>
                    ...
                    <div class="col-lg-12">
                        ...
                        <article class="pb-3">
                            <span class="text-center">
                                <h1>Direct selling companies </h1>
                            </span>
