                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="xs sm md">Picture</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="c_name"><?php echo $a; $a++; ?></p>
                                        </td>
                                      
                                        <td>
                                           <img src="../images/banner/<?php echo $result['image'];  ?>" width="40px" height="40px" >
                                        </td>
                                       
                                        <td>
                                            
                                           <a href="delete_slider_img.php?id=<?php echo $result['id']; ?>" class="btn btn-danger btn-sm"><i class="zmdi zmdi-delete"></i></a>
                                        </td>
                                    </tr>
