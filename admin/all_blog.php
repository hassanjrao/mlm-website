                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <p class="c_name"> <?php echo ucwords($result['title']) ?></p>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="edit_blog.php?id=<?php echo $result['id'] ?>" class="btn btn-primary btn-sm"><i class="zmdi zmdi-edit"></i></a>
                                                                <a href="delete_blog.php?id=<?php echo $result['id'] ?>" class="btn btn-danger btn-sm"><i class="zmdi zmdi-delete"></i></a>
                                                            </td>
                                                        </tr>
